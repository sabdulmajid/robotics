...
| Experiments + report | E | Current checkpoint complete, not final benchmark | `reports/openpi_project_status.md` and `reports/openpi_libero_risk_planning.md` contain numeric results, limitations, and reproduction commands. |
